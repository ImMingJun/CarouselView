 ...
 * @since 2020/6/18
 */
final class CarouselVerticalViewPager extends VerticalViewPager {
    public CarouselVerticalViewPager(@NonNull Context context) {
        super(context);
    }

    public CarouselVerticalViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
