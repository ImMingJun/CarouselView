 ...
 */
public final class Carousel2MarginPageTransformer implements ViewPager2.PageTransformer {
    private int margin;

    /**
     * Creates a {@link Carousel2MarginPageTransformer}.
     *
     * @param marginPx non-negative margin
     */
    public Carousel2MarginPageTransformer(@Px int marginPx) {
        margin = marginPx;
    }
