...
public class CenterSnapHelper extends RecyclerView.OnFlingListener {
    ...
    protected int mStartPosition = RecyclerView.NO_POSITION;
            ...
            new RecyclerView.OnScrollListener() {
                ...
                public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                    ...
                    if (newState == RecyclerView.SCROLL_STATE_DRAGGING) {//开始拖动
                        mStartPosition = layoutManager.getCurrentPositionOffset();
                    }

                    if (newState == RecyclerView.SCROLL_STATE_IDLE && mScrolled) {//静止
                        mScrolled = false;
